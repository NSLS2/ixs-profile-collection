...
class IXSStatsPlugin(StatsPlugin):
    # asyn_pipeline_config = None
    def describe_configuration(self):
        return ophyd.Device.describe_configuration(self)

    def read_configuration(self):
        return ophyd.Device.read_configuration(self)
...
class AH501(QuadEM):
    ...
    current1 = ADCpt(IXSStatsPlugin, 'Current1:')
    current2 = ADCpt(IXSStatsPlugin, 'Current2:')
    current3 = ADCpt(IXSStatsPlugin, 'Current3:')
    current4 = ADCpt(IXSStatsPlugin, 'Current4:')
